...
\begin{figure}[ht]
  \centering
  \subfloat[
  CA configuration used in creating a self-regulating organism. Green cells are
  FeedbackCells, to which Readout output is routed, and blue cells are output
  cells, regular SBlocks whose output state is routed as input to the Readout
  module.
  ]{\includegraphics[width=0.4\linewidth, valign=c]{fig/example-setup}}
  \quad
  \subfloat[
  Configuration of the Readout module used in the example
  self-regulating organism
  ]{\includegraphics[width=\linewidth, valign=c]{fig/example-readout}}
